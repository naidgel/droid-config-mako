# DisplayName: Jolla mako/@ARCH@ (release) 1
...
repo --name=adaptation-community-common-mako-@RELEASE@ --baseurl=http://repo.merproject.org/obs/nemo:/devel:/hw:/common/sailfish_latest_@ARCH@/
...
%packages
@Jolla Configuration mako
%end

%attachment
### Commands from /tmp/sandbox/usr/share/ssu/kickstart/attachment/mako
